...
public:
   ...
   ossim_float64 getMeanPixelValue() const;

   ossim_float64 getMedianPixelValue() const;

   ossim_float64 getStandardDeviation() const;
...
private:
   ...
   ossim_float64 theMeanPixelValue;     //< meters
   ossim_float64 theMedianPixelValue;
   ossim_float64 theStandardDeviation;
