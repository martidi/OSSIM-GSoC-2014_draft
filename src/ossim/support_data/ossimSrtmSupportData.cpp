                                                 ...
                                                 double defaultNull)
{
   ...
   accumulator_set<double, stats<tag::mean, tag::median, tag::variance> > acc;
   ...
   theMeanPixelValue = mean(acc);
   theMedianPixelValue = median(acc);
   theStandardDeviation = sqrt(variance(acc));
...
ossim_float64 ossimSrtmSupportData::getMeanPixelValue() const
{
   return theMeanPixelValue;
}

ossim_float64 ossimSrtmSupportData::getMedianPixelValue() const
{
   return theMedianPixelValue;
}

ossim_float64 ossimSrtmSupportData::getStandardDeviation() const
{
...
std::ostream& ossimSrtmSupportData::print(std::ostream& out) const
{
   out << std::setprecision(15) << "ossimSrtmSupportData data members:"
       ...
       << "\nMean post value:       " << theMeanPixelValue
       << "\nMedian post value:     " << theMedianPixelValue
